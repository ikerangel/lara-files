                ...
                >
                    ...
                    <div class="dropdown shrink-0">
                        <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start'" offsetDistance="8">
                            ...
                            <template #content="{ hideDropdown }"> // originalmente era { close }, pero lo cambiamos por evitar ambigüedades
                                    ...
                                    <template v-for="item in store.languageList" :key="item.code">
                                        <li>
                                            <button
                                                ...
                                                @click="changeLanguage(item), hideDropdown()"
                                            >
                                                <img
                            ...
                            <template #content="{ hideDropdown }">
                                <ul class="!py-0 text-dark dark:text-white-dark w-[300px] sm:w-[350px] divide-y dark:divide-white/10">
                                    ...
                                    <template v-if="notifications.length">
                                        <li>
                                            <div class="p-4">
                                                <button class="btn btn-primary block w-full btn-small" @click="hideDropdown()">Read All Notifications</button>
                                            </div>
                                        </li>
                                    </template>
                                    <template v-if="!notifications.length">
                    ...
                    <div class="dropdown shrink-0">
                        <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start'" offsetDistance="8" class="!block">
                            ...
                            <template #content="{ hideDropdown }"> <!-- originalmente era { close }, pero lo cambiamos por hideDropdown por evitar ambigüedades -->
                                 <ul class="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    ...
                                    <li>
                                        <router-link to="/users/profile" class="dark:hover:text-white" @click="hideDropdown()">
                                            <svg
                                    ...
                                    <li>
                                        <router-link to="/apps/mailbox" class="dark:hover:text-white" @click="hideDropdown()">
                                            <svg
                                                class="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0"
                                                width="18"
                                                height="18"
                                    ...
                                    <li>
                                        <router-link to="/auth/boxed-lockscreen" class="dark:hover:text-white" @click="hideDropdown()">
                                            <svg
                                                class="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0"
                                                width="18"
                                                height="18"
                                    ...
                                    <li class="border-t border-white-light dark:border-white-light/10">
                                        <router-link to="/auth/boxed-signin" class="text-danger !py-3" @click.prevent="handleSignOut(hideDropdown())">
                                            <svg
...
<script lang="ts" setup>
    ...
    function handleSignOut(hideDropdown: () => void) {
      hideDropdown();        // first close your UI
      onSignOut();    // then do the logout + redirect
    }
